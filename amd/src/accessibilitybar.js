...
define(['jquery', 'core/ajax'], function(jQuery, Ajax) {
    ...
    var SELECTORS = {
        ...
        SITE_COLOR: '#sitecolor_color1, #sitecolor_color2, #sitecolor_color3, #sitecolor_color4, #sitecolor_colordark, #sitecolor_colortri, #sitecolor_colorpto, #sitecolor_colordeu',
